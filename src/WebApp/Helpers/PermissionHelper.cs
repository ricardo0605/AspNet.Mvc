...
namespace WebApp.Helpers
{
    public static class PermissionHelper
    {
        ...
        {
            return ValidPermission(claimName, claimValue) ? value : MvcHtmlString.Empty;
        }

        public static bool IfClaim(this WebViewPage page, string claimName, string claimValue)
        {
            return ValidPermission(claimName, claimValue);
        }

        public static bool ValidPermission(string claimName, string claimValue)
        {
